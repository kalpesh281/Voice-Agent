"""
Tool execution — routes tool calls to the right service functions.
Used by run.py (standalone) and can be used by any agent runner.
"""
...
from agent.config import TOKEN_PERCENTAGE
